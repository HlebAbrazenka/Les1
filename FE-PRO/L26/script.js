...
// в котором будут элементы цена которых больше 1000
...
// Создайте новый массив, чье произведение стоимости
// и количества будет превышать значения 10000


// let result = products.filter( value => value.price * value.count > 10000)
// console.log(result);

//---------------------------------------------------------------------


// Найдите товар, чье произведение стоимости
// и количества будет превышать значения 10000
...
// Cоздайте новый массив, который будет перечислять
// только значения произведения цены и количества
// [4000, 20000, ...]
